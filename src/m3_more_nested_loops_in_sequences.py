...
def run_test_largest_number():
    ...
    expected = 22
    answer = largest_number([(3,22,11),(12,20,1)])
    print('Expectedand actual are :', expected , answer)
...
def run_test_largest_negative_number():
    ...
    #Test 1:
    expected = None
    answer = largest_negative_number([(3,1,4),(1 ,1 ,1)])
    print('Expected and actual are:', expected , answer)

    # Test 2:
    expected = -2
    answer = largest_negative_number([(3,-2,1), (3, 4, 5)])
    print('Expected and actual are:', expected, answer)
